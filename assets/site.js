(() => {
  ...
  const functionsLink = heroActions?.querySelector('a[href="/functions/"]');
  if (functionsLink) functionsLink.textContent = 'Подробнее о функциях';
  ...
  // Вместо условного CSS-макета показываем реальную рабочую панель
  // публичной демо-версии. Специальный preview-режим на demo.pz-med.ru
  // скрывает служебную плашку и переводит любой клик в полноценное демо.
